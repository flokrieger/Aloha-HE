...
################################################################
# This is a generated script based on design: bd_7499
#
...
proc create_hier_cell_s02_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MSC000_RDATA_WIDTH {256} \
   CONFIG.MSC000_WDATA_WIDTH {256} \
   CONFIG.NUM_MSC {1} \
   CONFIG.NUM_READ_OUTSTANDING {2} \
   ...
   CONFIG.SEP000_RDATA_WIDTH {256} \
   CONFIG.SEP000_WDATA_WIDTH {256} \
   CONFIG.SUPPORTS_NARROW {0} \
...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  connect_bd_net -net clk_map_aclk_net [get_bd_pins S00_ACLK] [get_bd_pins S01_ACLK] [get_bd_pins S02_ACLK] [get_bd_pins aclk] [get_bd_pins swbd_aclk] [get_bd_pins psr_aclk/slowest_sync_clk]
  ...
  connect_bd_net -net psr_aclk_interconnect_aresetn [get_bd_pins S00_ARESETN] [get_bd_pins S01_ARESETN] [get_bd_pins S02_ARESETN] [get_bd_pins swbd_aresetn] [get_bd_pins psr_aclk/interconnect_aresetn]
